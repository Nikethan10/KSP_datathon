...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'predict.networkHint': { en: 'colour = threat level · hover to trace links · click a gang to focus', kn: 'ಬಣ್ಣ = ಬೆದರಿಕೆ ಮಟ್ಟ · ಸಂಪರ್ಕ ಪತ್ತೆಗೆ ಹೋವರ್ · ಗಮನಕ್ಕೆ ಗ್ಯಾಂಗ್ ಕ್ಲಿಕ್ ಮಾಡಿ' },
  ...
  'predict.gangs': { en: 'gangs', kn: 'ಗ್ಯಾಂಗ್‌ಗಳು' },
  'predict.modularity': { en: 'modularity', kn: 'ಮಾಡ್ಯುಲಾರಿಟಿ' },
  'predict.gangDisruption': { en: 'Gang disruption ranking', kn: 'ಗ್ಯಾಂಗ್ ವಿಘಟನೆ ಶ್ರೇಣಿ' },
  'predict.threatRanking': { en: 'Gangs by threat level', kn: 'ಬೆದರಿಕೆ ಮಟ್ಟದ ಪ್ರಕಾರ ಗ್ಯಾಂಗ್‌ಗಳು' },
  'predict.threatScore': { en: 'threat', kn: 'ಬೆದರಿಕೆ' },
  ...
  'threat.reachTip': { en: 'districts the gang operates across', kn: 'ಗ್ಯಾಂಗ್ ಕಾರ್ಯನಿರ್ವಹಿಸುವ ಜಿಲ್ಲೆಗಳು' },
  'threat.title': { en: 'Gang threat level', kn: 'ಗ್ಯಾಂಗ್ ಬೆದರಿಕೆ ಮಟ್ಟ' },
  ...
  'war.highProfile': { en: 'Most Wanted', kn: 'ಅತಿ ಬೇಕಾದವರು' },
  ...
  'board.boss': { en: 'BOSS', kn: 'ಮುಖ್ಯಸ್ಥ' },
  'board.lieutenant': { en: 'LIEUTENANT', kn: 'ಸಹಾಯಕ' },
  ...
  'trust.gangFrag': { en: 'gang fragmentation', kn: 'ಗ್ಯಾಂಗ್ ವಿಘಟನೆ' },
