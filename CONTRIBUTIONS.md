...
| **Hari Nair** | `@r-harinarayanan` | **Analytics & Machine Learning Pipeline**<br>• LightGBM risk prediction model with spatio-temporal near-repeat features<br>• STL anomaly detection & daily crime spike detection algorithm<br>• Model evaluation metrics (PAI 10.63 @ top 5% area, RRI 1.27 vs status quo) |
